            ...
            <div className="rsp-2col" style={{ position:"relative", display:"grid", gridTemplateColumns:"1fr 1fr", gap:56, alignItems:"center" }}>
              ...
              <div>
                ...
                <div style={{ display:"flex", gap:12, flexWrap:"wrap" }}>
                  <a href="https://wa.me/919266117055" className="hw-btn-teal" style={{ textDecoration:"none" }}>
                  ...
                  <a href="tel:+919266117055" className="hw-btn-ghost-d" style={{ textDecoration:"none" }}>
